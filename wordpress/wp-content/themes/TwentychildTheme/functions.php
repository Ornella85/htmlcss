<?php
/*Ce fichier fait partie deTwentychildTheme, twentytwentyone child theme.
...
if ( ! function_exists( 'suffice_child_enqueue_child_styles' ) ) {
	function TwentychildTheme_enqueue_child_styles() {
...
add_action( 'wp_enqueue_scripts', 'TwentychildTheme_enqueue_child_styles' );
